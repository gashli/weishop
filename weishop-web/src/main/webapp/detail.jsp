	...
	$.ajax({
	    ...
	    success: function(data) {
	        if(data.status==0){
	        	...
	        	$("#propicture").attr("src",data.product.picture);
	        	$("#title").html(data.product.title);
	        	$("#protitle").html(data.product.title);
	        	$("#proprice").html("￥"+data.product.money);
	        	$("#procontent").html(data.product.content);
	        	$("#buyNow").attr("href","user/cart?pid="+data.product.id);
	        }
	    }
	});
});
