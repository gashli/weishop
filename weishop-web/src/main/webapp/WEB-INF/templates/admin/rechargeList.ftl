<form id="pagerForm" onsubmit="return navTabSearch(this);" com.action="rechargeList" method="post">
        <input type="hidden" name="pageCurrent" value="${page.pageCurrent}">
        <input type="hidden" name="pageSize" value="${page.pageSize}">
</form>
<div class="bjui-pageHeader">
    <form id="pagerForm" data-toggle="ajaxsearch" com.action="rechargeList" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
        ...
        <#list rechargeList as recharge>
            <tr>
                ...
                <td>
                    <a href="rechargeDelete.com.action?id=${recharge.id?string('#')}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删</a>
                </td>
            </tr>
		</#list>
		</tbody>
