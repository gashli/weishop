...
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="res/images/lxinetlogo.png" >
        </div>
        <div class="login_form">
    		<form com.action="adminLoginResult" class="ajax_form" method="post">
	...
	<div class="bottom">Copyright &copy; 2012 - 2015 <a href="http://www.lxinet.com" target="_blank">凌夕网络</a> <a href="http://bbs.lxinet.com" target="_blank">凌夕网络论坛</a> <a href="http://www.919dns.com" target="_blank">919数据中心</a></div>
</div>
</body>
</html>