<form id="pagerForm" onsubmit="return navTabSearch(this);" com.action="rechargeCardList" method="post">
...
<div class="bjui-pageHeader">
        <ul class="bjui-searchBar">
            <li>
            <form id="pagerForm" data-toggle="ajaxsearch" com.action="rechargeCardList" method="post">
    ...
    <table data-toggle="tablefixed" data-width="100%" data-layout-h="0" data-nowrap="true">
        ...
        <#list rechargeCardList as rechargeCard>
            <tr>
                ...
                <td>
                    <a href="rechargeCardDelete.com.action?id=${rechargeCard.id?string('#')}" class="btn btn-red" data-toggle="doajax" data-confirm-msg="确定要删除该行信息吗？">删</a>
                </td>
            </tr>
		</#list>
		</tbody>
