	    ...
	    success: function(data) {
	        if(data.status==1){
	        	...
	        	for(var i=0;i<list.length;i++){
	        		$("#productsList").append("<li><a href='detail.jsp?id="+list[i].id+"' class='block wbox' ><label class='meb-list-ico' style='background:url(\"images/ico-myDate.png\") no-repeat left center;background-size:1rem 1rem;'>"+list[i].title+"</label><div class='wbox-flex tr sn-txt-muted arrow'>¥"+list[i].money+"</div></a></li>");
	        	}
